      ...
      <div className="drawer lg:drawer-open max-h-screen">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="dropdown dropdown-end">
                ...
                <ul tabIndex={0} className="dropdown-content menu bg-white rounded-2xl z-[1] w-64 p-4 shadow-xl border border-gray-100 mt-4 space-y-2">
                  ...
                  <li><Link href="/admin/profile" className="font-bold text-gray-700 hover:bg-primary/5 active:bg-primary/10 rounded-xl py-3">My Account</Link></li>
        ...
        <div className="drawer-side z-40">
          ...
          <div className="bg-white border-r border-gray-100 w-80 min-h-full p-6 flex flex-col">
            <Link href="/admin/dashboard" className="flex items-center gap-3 px-4 mb-12">
            ...
            <div className="flex-1 space-y-2">
              <p className="px-4 text-[10px] font-black uppercase tracking-[0.3em] text-gray-400 mb-6">Main Navigation</p>
            ...
            <div className="mt-auto pt-6">
              <div className="bg-primary/5 rounded-[2rem] p-6 text-center border border-primary/10">
                ...
                <p className="text-sm font-black text-gray-900 mb-1">Eco-System Active</p>
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-relaxed">Admin panel is fully synced with blockchain nodes.</p>
              </div>
            </div>
          </div>
        </div>
