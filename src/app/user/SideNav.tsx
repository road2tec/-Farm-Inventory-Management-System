    ...
    <>
      <div className="drawer lg:drawer-open max-h-screen">
        ...
        <div className="drawer-content flex flex-col bg-gray-50">
              ...
              <div className="dropdown dropdown-end">
                <div tabIndex={0} role="button" className="flex items-center gap-3 hover:bg-gray-50 p-2 rounded-2xl transition-colors">
                  <div className="flex flex-col items-end hidden md:flex">
                    ...
                    <span className="text-[10px] font-bold text-primary uppercase tracking-widest">Consumer</span>
                  </div>
                ...
                <ul tabIndex={0} className="dropdown-content menu bg-white rounded-2xl z-[1] w-64 p-4 shadow-xl border border-gray-100 mt-4 space-y-2">
                  ...
                  <li><Link href="/user/profile" className="font-bold text-gray-700 hover:bg-primary/5 active:bg-primary/10 rounded-xl py-3">My account</Link></li>
          ...
          <main className="overflow-y-auto h-[calc(100vh-5rem)] p-6 lg:p-10 text-gray-900">
            {children}
          </main>
        </div>
        ...
        <div className="drawer-side z-40">
          ...
          <div className="bg-white border-r border-gray-100 w-80 min-h-full p-6 flex flex-col">
            <Link href="/user/dashboard" className="flex items-center gap-3 px-4 mb-12">
            ...
            <div className="flex-1 space-y-2">
              <p className="px-4 text-[10px] font-black uppercase tracking-[0.3em] text-gray-400 mb-6">Shopping Menu</p>
            ...
            <div className="mt-auto pt-6">
              <div className="bg-accent/10 rounded-[2rem] p-6 text-center border border-accent/20">
                <IconBasket className="mx-auto text-accent mb-3" size={32} />
                <p className="text-sm font-black text-gray-900 mb-1">Local & Fresh</p>
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-relaxed text-gray-500">You are supporting 14 direct-to-consumer farms.</p>
              </div>
            </div>
          </div>
        </div>
