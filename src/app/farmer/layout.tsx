...
const Component = ({
        ...
        <body className="bg-white min-h-screen flex items-center justify-center text-primary">
          <div className="flex flex-col items-center gap-6 animate-pulse">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-xs font-medium text-gray-500">Verifying farmer access...</p>
            </div>
          </div>
        </body>
      </html>
  ...
  return (
    <html lang="en">
      <head>
        <title>Farm Inventory - Farmer Dashboard</title>
        <meta name="description" content="Manage your farm inventory and products" />
      </head>
